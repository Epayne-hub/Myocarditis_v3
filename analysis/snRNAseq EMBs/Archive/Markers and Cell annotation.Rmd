...
colclusterName <- c("#fcc5c0" ,"#f4a582", "#FEE08B", "#feb24c","#8c2d04", "#01665e", "#66C2A5", "#43a2ca", "#355C7D","#3288BD","#a6bddb", "#91003f")
...
levels(seuratM)
markers25 <- FindAllMarkers(seuratM, only.pos = T) %>%
                            dplyr::filter(p_val_adj < 0.01)
...
```{r}
"~/Documents/01 Projects/00 snRNAseq/00 Myocarditis/data/Merged/Myocarditis_all_files_layers_22.02.26_filt_annotated_doubletsremovedv5_normal_scaling_AM_only.rds")
```
