---
title: "EMB cluster annotation all cells and Feature Plots"
author: "EP"
date: "`r Sys.Date()`"
...
seuratM <- readRDS("~/Documents/GitHub/Myocarditis_v3/data/Merged snRNAseq EMBs/EMB_Myocarditis_SC_transformed_doublet_removal_annotated_full_metadata_09_3_26")
...
#seuratM$clusterName[which(seuratM$RNA_snn_res.0.25 %in% "7" )] <- "Fb2" ## Doublet removed
...
#seuratM$clusterName[which(seuratM$RNA_snn_res.0.25 %in% "12" )] <- "Fb2" ## Doublet removed
...
table(seuratM$RNA_snn_res.0.8)
seuratM <- subset(seuratM, !RNA_snn_res.0.8 %in% c("20", "7","21", "22", "26","28", "30", "31"))
...
## Baroreceptors, ganglionic and neuronal: PIEZO1, TRPV2, and TRPM4,

FeaturePlot(seuratM, features = get_full_gene_name("PIEZO1",seuratM) , pt.size = 1, cols = c("lightgrey", "#BE3144"))#  cells
...
FeaturePlot(seuratM, features = get_full_gene_name("ASIC2",seuratM) , pt.size = 1, cols = c("lightgrey", "#BE3144"))# 
